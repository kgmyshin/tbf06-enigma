...
//image[reflector_1][Bに入力があったら、Vを出力する]{
//}

またペアになっているので、逆に@<code>{V}に入力があれば、@<code>{B}が出力されます。

//image[reflector_2][Vに入力があったら、Bを出力する]{
//}
...
では、ここにローターを組み合わせた時の様子を見てみましょう。

ローターに@<code>{E}の入力を渡すと、@<code>{Y}の出力がありました。

//image[reflector__rotor_1][ローターとリフレクター①]{
//}

この状態の時に@<code>{E}ではなくて@<code>{Y}の入力を与えると、@<code>{E}が出力されます。

//image[reflector__rotor_2][ローターとリフレクター②]{
//}
